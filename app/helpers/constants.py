...
# Quality presets
QUALITY_PRESETS = {"low": 50, "medium": 75, "high": 90, "maximum": 95, "lossless": 100}
...
AUDIO_FORMATS = {
    ...
    "mqa": {
        "name": "Master Quality Authenticated",
        "year": 2014,
        "lossy": False,
        "max_bitrate": "Lossless",
        "supports_metadata": True,
...
TASK_PRIORITIES = {"high": 9, "normal": 5, "low": 1}

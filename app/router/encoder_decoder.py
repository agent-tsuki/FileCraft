    ...
    return JSONResponse(content={
        ...
        "encoders": {
            "base64": {
                ...
                "use_cases": ["File transmission", "Data serialization", "Email attachments"]
            },
            "jwt": {
                "description": "JSON Web Token creation and signing",
                "endpoint": "/codec/encode/jwt",
                "algorithms": ["HS256", "HS384", "HS512", "RS256", "ES256"],
                "use_cases": ["Authentication", "API authorization", "Secure data exchange"]
            },
            "url": {
            ...
            "hash": {
                ...
                "use_cases": ["Data integrity", "Password storage", "Digital signatures"]
            }
        },
        ...
        "decoders": {
            "base64": {
                ...
                "features": ["Auto-detection", "Padding correction", "Format validation"]
            },
            "jwt": {
                "description": "JWT token verification and payload extraction",
                "endpoint": "/codec/decode/jwt", 
                "features": ["Signature verification", "Expiration checking", "Header inspection"]
            },
            "url": {
                "description": "URL decoding from percent-encoded format",
                "endpoint": "/codec/decode/url",
                "features": ["Parameter parsing", "Component extraction", "Error handling"]
            },
            "hex": {

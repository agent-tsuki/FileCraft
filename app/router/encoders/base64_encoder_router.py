...
from app.services.encoders.base64_encoder import Base64EncoderService, get_base64_encoder_service
...
async def encode_file_to_base64(
    ...
    if return_stream:
        ...
        output_filename = service.get_output_filename(file.filename or "unknown", url_safe=url_safe)

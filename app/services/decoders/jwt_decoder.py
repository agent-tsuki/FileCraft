    ...
    async def decode(
        ...
        **kwargs
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"JWT decoding failed: {str(e)}")
    ...
    def get_token_info(self, token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "has_expiration": "exp" in payload if isinstance(payload, dict) else False,
                "algorithm": header.get("alg"),
                "token_type": header.get("typ", "JWT")
            }
        except Exception as e:
            raise HTTPException(status_code=400, detail=f"Failed to get token info: {str(e)}")

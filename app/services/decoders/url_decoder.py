...
class URLDecoderService(BaseDecoderService):
    ...
    async def decode(
        ...
        **kwargs
        ...
        try:
            ...
            decoded = urllib.parse.unquote(string_data, encoding=encoding, errors=errors)
            return decoded
        
        except Exception as e:
            raise HTTPException(status_code=400, detail=f"URL decoding failed: {str(e)}")
    ...
    def decode_query_params(self, query_string: str, **kwargs) -> dict:
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"Query parameter decoding failed: {str(e)}")

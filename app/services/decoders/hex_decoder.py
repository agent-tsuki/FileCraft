...
class HexDecoderService(BaseDecoderService):
    ...
    async def decode(
        ...
        **kwargs
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"Hex decoding failed: {str(e)}")
    ...
    async def decode_to_text(self, hex_data: str, encoding: str = 'utf-8', **kwargs) -> str:
        """
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"Hex to text decoding failed: {str(e)}")
    ...
    def decode_with_length_prefix(self, hex_data: str, **kwargs) -> bytes:
        ...
        if len(cleaned_hex) < 4:
            raise HTTPException(status_code=400, detail="Invalid length-prefixed hex data")
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"Invalid length prefix: {str(e)}")

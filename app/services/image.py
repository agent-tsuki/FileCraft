...
from app.helpers.constants import (
    IMAGE_FORMATS, SUPPORTED_OUTPUT_FORMATS, QUALITY_PRESETS, 
    SIZE_PRESETS, IMAGE_OPTIMIZATION
)
...
class ImageService(BaseService):
    ...
    def __init__(self, config: AppConfig, validation_service: FileValidationService):
        ...
        self.executor = ThreadPoolExecutor(max_workers=4)  # For CPU-intensive operations
    ...
    async def convert_image_format(
        ...
        try:
            ...
            if use_async and CELERY_AVAILABLE and self._is_redis_available():
                try:
                    ...
                    task = convert_image_async.delay(
                        content, target_format, quality, optimization_level, resize_options
                    )
            ...
            result = await asyncio.get_event_loop().run_in_executor(
                ...
                content, target_format, quality, resize_options, optimization_level
            )
    ...
    def _convert_image_sync(
        ...
        with Image.open(input_buffer) as img:
            ...
            save_kwargs = self._get_save_parameters(save_format, quality, optimization_level)
    ...
    def _resize_image(self, img: Image.Image, resize_options: Dict[str, Any]) -> Image.Image:
    ...
    def _get_save_parameters(self, format_name: str, quality: int, optimization_level: str) -> Dict[str, Any]:
    ...
    async def optimize_image(
        ...
        return await asyncio.get_event_loop().run_in_executor(
            ...
            content, optimization_type, target_size_kb
        )
    ...
    def _convert_optimized(self, img: Image.Image, format_name: str, quality: int) -> BinaryIO:

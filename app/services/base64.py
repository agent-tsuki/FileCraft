...
class Base64Service(BaseService):
    ...
    async def convert_to_base64_stream(
        self, file: UploadFile, compress: bool = False
        ...
        try:
            ...
            if compress:
                ...
                self.log_operation(
                    ...
                    {
                        "original_size": (
                            len(await file.read()) if hasattr(file, "read") else 0
                        ),
            ...
            self.log_operation("base64_conversion_completed", {"filename": filename})

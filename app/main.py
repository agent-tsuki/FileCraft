    ...
    def get_public_config() -> Dict[str, Any]:
        ...
        return {
            ...
            "rate_limiting": {
                ...
                "requests_per_window": config.rate_limit_requests if config.rate_limit_enabled else None,
                "window_seconds": config.rate_limit_window if config.rate_limit_enabled else None,
            },
            "file_processing": {
                "max_upload_size_mb": config.max_upload_size // (1024 * 1024),
